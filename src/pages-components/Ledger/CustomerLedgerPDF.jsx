...
const CustomerLedgerPDF = ({ ledgerData, startDate, endDate, totalCredited, totalDebited, totalBalance, openingBalance }) => {
   console.log(totalBalance, 'ooo')
   return (
      ...
      <Document>
         <Page size="A3" >
            ...
            <View style={{ width: "100%", height: "175px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "20px" }}>
               ...
               <Text style={{ fontWeight: "800", fontSize: "18px" }}>Customer Ledger Report</Text>
...
export const generateCustomerLedger = async (ledgerData, startDate, endDate, totalCredited, totalDebited, totalBalance, openingBalance) => {
