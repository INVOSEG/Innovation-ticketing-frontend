...
export default function UserManagement() {
  ...
  return (
    ...
    >
      <Box
        sx={{
          width: { xs: "100%", md: "120%" }, // give desktop extra width similar to 120% zoom
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ textAlign: "center" }}>Consultant</th>
